                        ...
                        <div  data-role = "content" id="productSample">
                            ...
                            <div data-role="content">
                                ...
                                <div data-role="collapsible-set" data-content-theme="d" id="set" style="text-align: center">
                                    ...
                                    $content1.= "<div  id='sri'><div  data-role='content' id='set" . nextId . "'><div class='ui-grid-b'><div class='ui-block-a'><input class='ajax3' type='text' name='sproduct[]' placeholder='product' value='" . "' /></div>";
                                    $content1.="<div  class='ui-block-b'>" . coloue_input_html() . "</div>";
                                    $content1.="<div class='ui-block-c'><input class='ajax3' type='text' name='finish[]'  placeholder='Finish' value=''/></div></div></div></div>";
                                    ?>
                                    <?php //echo $content ?>
                                    <?php echo $content1 ?>
                                </div>
