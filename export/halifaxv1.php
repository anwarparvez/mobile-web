...
?>
	...
	<?php require_once("contents/fields.php"); ?>
		<form action="contents/server.php" method="post" data-ajax="false" >
			<table border="1" cellspacing="0" cellpadding="0" bordercolor="#EAEAEA">
				...
				</td><td rowspan="2" colspan="2"><table border="1" cellspacing="0" cellpadding="0" bordercolor="#EAEAEA"><tr><td>Follow up date:<input type="date" name="follow_up_date" id="follow_up_date" placeholder="dd/mm/yyyy" value="" rowId="0" class="ajax3" data-role="datebox" data-options='{"mode": "calbox"}' /></td><td rowspan="2">Est. project run:<input type="number" name="est_project_run" id="est_project_run" placeholder="Est. project run" rowId="0" class="ajax3" />mths</td></tr><tr><td>Est. Delivery:<input type="date" name="est_delivery" id="est_delivery" placeholder="dd/mm/yyyy" value="" rowId="0" class="ajax3" data-role="datebox" data-options='{"mode": "calbox"}' /></td></tr></table>
				</td></tr>
				<tr><td>
			...
			<table>
			<tr><td><input type="submit" value="Save" name="save" rowId="0"  class="ajax4" data-role="button" data-icon="plus" /></td>
			<td><a href="divider.php" data-ajax="false" data-role="button" data-icon="grid">Reporting</a></td></tr></table>
		</form>
	</div><!-- /content -->
