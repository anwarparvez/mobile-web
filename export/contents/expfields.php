		...
		if(!preg_match('/MSIE/i',$u_agent))  {
			...
			<td>
				...
				<select class="drop" name="project_status" rowId="'.$row['ID'].'" >
					...
					<option value="OPEN" ';if($row['project_status']=='OPEN') echo 'selected'; echo '>OPEN</option>
					<option value="CLOSED" ';if($row['project_status']=='CLOSED') echo 'selected'; echo '>CLOSED</option>
				</select>
				</div></td>
			...
			<td>
				...
				<select class="drop" name="state" rowId="'.$row['ID'].'" >
							...
							<option value="NSW" ';if($row['state']=='NSW') echo 'selected'; echo '>NSW</option>
							<option value="VIC" ';if($row['state']=='VIC') echo 'selected'; echo '>VIC</option>
							<option value="QLD" ';if($row['state']=='QLD') echo 'selected'; echo '>QLD</option>
							<option value="ACT" ';if($row['state']=='ACT') echo 'selected'; echo '>ACT</option>
							<option value="WA" ';if($row['state']=='WA') echo 'selected'; echo '>WA</option>
							<option value="SA" ';if($row['state']=='SA') echo 'selected'; echo '>SA</option>
							<option value="TAS" ';if($row['state']=='TAS') echo 'selected'; echo '>TAS</option>
				</select>
				</div>
			...
			<td>
				...
				<div class="ajax2 hide"><select name="colour" class="drop" onChange="updateDate()" rowId="'.$row['ID'].'" >
					...
					<option value="Blanc ChromaShield&trade; 201" ';if($row['colour']=='Blanc ChromaShield&trade; 201') echo 'selected'; echo '>Blanc ChromaShield&trade; 201</option>
					<option value="Blanc ChromaShield&trade; 201 " ';if($row['colour']=='Blanc ChromaShield&trade; 201 ') echo 'selected'; echo '>Blanc ChromaShield&trade; 201</option>
					<option value="Ebony ChromaShield&trade; 202" ';if($row['colour']=='Ebony ChromaShield&trade; 202') echo 'selected'; echo '>Ebony ChromaShield&trade; 202</option>
					<option value="Ebony ChromaShield&trade; 202 " ';if($row['colour']=='Ebony ChromaShield&trade; 202 ') echo 'selected'; echo '>Ebony ChromaShield&trade; 202</option>
					<option value="Rawform ChromaShield&trade; 203" ';if($row['colour']=='Rawform ChromaShield&trade; 203') echo 'selected'; echo '>Rawform ChromaShield&trade; 203</option>
					<option value="Rawform ChromaShield&trade; 203 " ';if($row['colour']=='Rawform ChromaShield&trade; 203 ') echo 'selected'; echo '>Rawform ChromaShield&trade; 203</option>
					<option value="Stone ChromaShield&trade; 204" ';if($row['colour']=='Stone ChromaShield&trade; 204') echo 'selected'; echo '>Stone ChromaShield&trade; 204</option>
					<option value="Stone ChromaShield&trade; 204 " ';if($row['colour']=='Stone ChromaShield&trade; 204 ') echo 'selected'; echo '>Stone ChromaShield&trade; 204</option>
					<option value="Toast ChromaShield&trade; 205" ';if($row['colour']=='Toast ChromaShield&trade; 205') echo 'selected'; echo '>Toast ChromaShield&trade; 205</option>
					<option value="Toast ChromaShield&trade; 205 " ';if($row['colour']=='Toast ChromaShield&trade; 205 ') echo 'selected'; echo '>Toast ChromaShield&trade; 205</option>
					<option value="Pewter ChromaShield&trade; 206" ';if($row['colour']=='Pewter ChromaShield&trade; 206') echo 'selected'; echo '>Pewter ChromaShield&trade; 206</option>
					<option value="Pewter ChromaShield&trade; 206 " ';if($row['colour']=='Pewter ChromaShield&trade; 206 ') echo 'selected'; echo '>Pewter ChromaShield&trade; 206</option>
					<option value="Greige ChromaShield&trade; 207" ';if($row['colour']=='Greige ChromaShield&trade; 207') echo 'selected'; echo '>Greige ChromaShield&trade; 207</option>
					<option value="Greige ChromaShield&trade; 207 " ';if($row['colour']=='Greige ChromaShield&trade; 207 ') echo 'selected'; echo '>Greige ChromaShield&trade; 207</option>
					<option value="Coco ChromaShield&trade; 208" ';if($row['colour']=='Coco ChromaShield&trade; 208') echo 'selected'; echo '>Coco ChromaShield&trade; 208</option>
					<option value="Coco ChromaShield&trade; 208 " ';if($row['colour']=='Coco ChromaShield&trade; 208 ') echo 'selected'; echo '>Coco ChromaShield&trade; 208</option>
					<option value="Flannel ChromaShield&trade; 209" ';if($row['colour']=='Flannel ChromaShield&trade; 209') echo 'selected'; echo '>Flannel ChromaShield&trade; 209</option>
					<option value="Flannel ChromaShield&trade; 209 " ';if($row['colour']=='Flannel ChromaShield&trade; 209 ') echo 'selected'; echo '>Flannel ChromaShield&trade; 209</option>
					<option value="Spring ChromaShield&trade; 210" ';if($row['colour']=='Spring ChromaShield&trade; 210') echo 'selected'; echo '>Spring ChromaShield&trade; 210</option>
					<option value="Spring ChromaShield&trade; 210 " ';if($row['colour']=='Spring ChromaShield&trade; 210 ') echo 'selected'; echo '>Spring ChromaShield&trade; 210</option>
					<option value="Russet ChromaShield&trade; 211" ';if($row['colour']=='Russet ChromaShield&trade; 211') echo 'selected'; echo '>Russet ChromaShield&trade; 211</option>
					<option value="Russet ChromaShield&trade; 211 " ';if($row['colour']=='Russet ChromaShield&trade; 211 ') echo 'selected'; echo '>Russet ChromaShield&trade; 211</option>
					<option value="Rouge ChromaShield&trade; 212" ';if($row['colour']=='Rouge ChromaShield&trade; 212') echo 'selected'; echo '>Rouge ChromaShield&trade; 212</option>
					<option value="Rouge ChromaShield&trade; 212 " ';if($row['colour']=='Rouge ChromaShield&trade; 212 ') echo 'selected'; echo '>Rouge ChromaShield&trade; 212</option>
					<option value="Turquoise ChromaShield&trade; 213" ';if($row['colour']=='Turquoise ChromaShield&trade; 213') echo 'selected'; echo '>Turquoise ChromaShield&trade; 213</option>
					<option value="Turquoise ChromaShield&trade; 213 " ';if($row['colour']=='Turquoise ChromaShield&trade; 213 ') echo 'selected'; echo '>Turquoise ChromaShield&trade; 213</option>
				</select></div>
			...
			<td>
				...
				<div class="ajax6 hide"><input type="date" name="job_entered" placeholder="dd/mm/yyyy" value="'.$row['job_entered'].'" rowId="'.$row['ID'].'"  ';?> data-role="datebox" data-options='{"mode": "calbox"}'<?php echo'/></div></td>
				';
		} else {
		...
		echo '
			...
			<td>
				...
				<div class="IEDrop noprint"><select name="colour" class="drop" rowId="'.$row['ID'].'" data-mini="true">
					...
					<option value="Blanc ChromaShield&trade; 201" ';if(stristr($row['colour'], '201')) echo 'selected'; echo '>Blanc ChromaShield&trade; 201</option>
					<option value="Blanc ChromaShield&trade; 201 " ';if(stristr($row['colour'], '201 ')) echo 'selected'; echo '>Blanc ChromaShield&trade; 201</option>
					<option value="Ebony ChromaShield&trade; 202" ';if(stristr($row['colour'], '202')) echo 'selected'; echo '>Ebony ChromaShield&trade; 202</option>
					<option value="Ebony ChromaShield&trade; 202 " ';if(stristr($row['colour'], '202 ')) echo 'selected'; echo '>Ebony ChromaShield&trade; 202</option>
					<option value="Rawform ChromaShield&trade; 203" ';if(stristr($row['colour'], '203')) echo 'selected'; echo '>Rawform ChromaShield&trade; 203</option>
					<option value="Rawform ChromaShield&trade; 203 " ';if(stristr($row['colour'], '203 ')) echo 'selected'; echo '>Rawform ChromaShield&trade; 203</option>
					<option value="Stone ChromaShield&trade; 204" ';if(stristr($row['colour'], '204')) echo 'selected'; echo '>Stone ChromaShield&trade; 204</option>
					<option value="Stone ChromaShield&trade; 204 " ';if(stristr($row['colour'], '204 ')) echo 'selected'; echo '>Stone ChromaShield&trade; 204</option>
					<option value="Toast ChromaShield&trade; 205" ';if(stristr($row['colour'], '205')) echo 'selected'; echo '>Toast ChromaShield&trade; 205</option>
					<option value="Toast ChromaShield&trade; 205 " ';if(stristr($row['colour'], '205 ')) echo 'selected'; echo '>Toast ChromaShield&trade; 205</option>
					<option value="Pewter ChromaShield&trade; 206" ';if(stristr($row['colour'], '206')) echo 'selected'; echo '>Pewter ChromaShield&trade; 206</option>
					<option value="Pewter ChromaShield&trade; 206 " ';if(stristr($row['colour'], '206 ')) echo 'selected'; echo '>Pewter ChromaShield&trade; 206</option>
					<option value="Greige ChromaShield&trade; 207" ';if(stristr($row['colour'], '207')) echo 'selected'; echo '>Greige ChromaShield&trade; 207</option>
					<option value="Greige ChromaShield&trade; 207 " ';if(stristr($row['colour'], '207 ')) echo 'selected'; echo '>Greige ChromaShield&trade; 207</option>
					<option value="Coco ChromaShield&trade; 208" ';if(stristr($row['colour'], '208')) echo 'selected'; echo '>Coco ChromaShield&trade; 208</option>
					<option value="Coco ChromaShield&trade; 208 " ';if(stristr($row['colour'], '208 ')) echo 'selected'; echo '>Coco ChromaShield&trade; 208</option>
					<option value="Flannel ChromaShield&trade; 209" ';if(stristr($row['colour'], '209')) echo 'selected'; echo '>Flannel ChromaShield&trade; 209</option>
					<option value="Flannel ChromaShield&trade; 209 " ';if(stristr($row['colour'], '209 ')) echo 'selected'; echo '>Flannel ChromaShield&trade; 209</option>
					<option value="Spring ChromaShield&trade; 210" ';if(stristr($row['colour'], '210')) echo 'selected'; echo '>Spring ChromaShield&trade; 210</option>
					<option value="Spring ChromaShield&trade; 210 " ';if(stristr($row['colour'], '210 ')) echo 'selected'; echo '>Spring ChromaShield&trade; 210</option>
					<option value="Russet ChromaShield&trade; 211" ';if(stristr($row['colour'], '211')) echo 'selected'; echo '>Russet ChromaShield&trade; 211</option>
					<option value="Russet ChromaShield&trade; 211 " ';if(stristr($row['colour'], '211 ')) echo 'selected'; echo '>Russet ChromaShield&trade; 211</option>
					<option value="Rouge ChromaShield&trade; 212" ';if(stristr($row['colour'], '212')) echo 'selected'; echo '>Rouge ChromaShield&trade; 212</option>
					<option value="Rouge ChromaShield&trade; 212 " ';if(stristr($row['colour'], '212 ')) echo 'selected'; echo '>Rouge ChromaShield&trade; 212</option>
					<option value="Turquoise ChromaShield&trade; 213" ';if(stristr($row['colour'], '213')) echo 'selected'; echo '>Turquoise ChromaShield&trade; 213</option>
					<option value="Turquoise ChromaShield&trade; 213 " ';if(stristr($row['colour'], '213 ')) echo 'selected'; echo '>Turquoise ChromaShield&trade; 213</option>
				</select></div>
				<div class="ajax1 show">'.$row['finish'].'</div>
				<div class="ajax2 hide"><input type="text" name="finish" rowId="'.$row['ID'].'" value="'.$row['finish'].'"  placeholder="Finish" /></div></td>
